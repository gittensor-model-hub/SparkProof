...
def test_validate_openrouter_trajectory_accepts_dated_fable_response_model():
    record = {
        "provider": "anthropic",
        "model": "claude-fable-5",
        "gateway": GATEWAY,
        "api_base": OPENROUTER_API_BASE,
        "request_url": OPENROUTER_CHAT_URL,
        "gateway_model": "anthropic/claude-fable-5-20260709",
        "openrouter_model": "anthropic/claude-fable-5-20260709",
        "metadata": {
            "openrouter_generation_id": "gen-abc",
            "openrouter_requested_model": "anthropic/claude-fable-5",
            "openrouter_response_model": "anthropic/claude-fable-5-20260709",
            "openrouter_reasoning_effort": "xhigh",
        },
    }
    validate_openrouter_trajectory(record)
